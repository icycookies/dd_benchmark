...
script_path=/code/script/generate_text.sh
generatesPy_path=/code/generate_samples.py
...
echo generatesPy_path

#deepspeed --num_nodes 1 --num_gpus 1 --master_port ${MASTER_PORT} generate_samples.py \
deepspeed --num_nodes 1 --num_gpus 1 --master_port ${MASTER_PORT} ${generatesPy_path} \
       --deepspeed \
