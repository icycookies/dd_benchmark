...
# generate()
def qa_noset_0127(model, tokenizer, args,content):
    output_string, output_string_score = generate_string(model, tokenizer, args, torch.cuda.current_device(), content)
