...
# PRETRAINED_MODEL_FILE = GENERATE_DIR + "/data_utils/chinese_sentencepiece/cog-pretrain.model"
# PRETRAINED_MODEL_FILE = "chinese_sentencepiece/cog-pretrain.model"

PRETRAINED_MODEL_FILE = os.path.dirname(os.path.dirname(__file__)) + "/chinese_sentencepiece/cog-pretrain.model"
def get_pairs(word):
    pairs = set()
    prev_char = word[0]
    for char in word[1:]:
