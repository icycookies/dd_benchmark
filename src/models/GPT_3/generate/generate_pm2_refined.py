...
def generate_sentence(model,tokenizer,args,device,current_tokens,mems,endnote=[",","，","?","？"],num_candidates=10,min_length=5,max_length=7,yayun=None):
    model.eval()
    with torch.no_grad():
        #index=len(tokens[0])
        mct_tree=[]
...
def set_args():
    ...
    args.load="/mnt3/useful_models/ts_human"
