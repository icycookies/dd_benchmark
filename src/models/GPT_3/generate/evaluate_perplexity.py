...
def generate_score(model, tokenizer, args, device,input_str,eval_str):
    ...
    sumlognum=sumlognum/eval_length
    return torch.exp(sumlognum)
...
def generate(fname):
    ...
    for line in w:
        ...
        score=generate_score(model, tokenizer, args, torch.cuda.current_device(),context_str,text_str)
        sumsample+=1
        sumscore+=score
        print("sample:",sumsample," score:",score, " avg score:",sumscore/sumsample)
